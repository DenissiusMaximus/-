<div class="max-w-lg">
    <h1 class="text-xl font-semibold text-gray-800 mb-4">Редагувати категорію #<?= $category->id ?></h1>

    <form method="POST" action="<?= url('categories/update/' . $category->id) ?>" class="bg-white border border-gray-200 rounded p-6 space-y-4">
