<div class="max-w-lg">
    <h1 class="text-xl font-semibold text-gray-800 mb-4">Нове джерело коштів</h1>

    <form method="POST" action="<?= url('sources/store') ?>" class="bg-white border border-gray-200 rounded p-6 space-y-4">
        ...
        <div>
            <label class="block text-sm text-gray-600 mb-1">Початковий баланс (грн)</label>
